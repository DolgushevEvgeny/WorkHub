...
public class DefaultValues {
    ...
    public static final String GET_OFFICES = "getOffices";
    public static final String GET_PLANS = "getPlans";
    public static final String GET_DAYWORKTIME = "getDayWorkTime";
    public static final String SET_RESERVATION = "setReservation";
